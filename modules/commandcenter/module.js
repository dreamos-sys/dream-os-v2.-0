 ...
 * Dream OS v2.0 — Self-Contained, auto-inject supabase jika belum ada
 */
...
async function initSupabase() {
    ...
    console.warn('[CC] Supabase tidak ditemukan, auto-inject CDN...');
    try {
        ...
        console.error('[CC] Gagal auto-inject supabase:', err);
        return false;
    }
}
