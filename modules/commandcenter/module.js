...
/* ════════════════════════════════════════════════════════
   EXPORT WRAPPER — support commandHub lama & baru
   Tambahkan di baris PALING BAWAH module.js
════════════════════════════════════════════════════════ */

// Support: commandHub baru → mod.default(...params)  ✅ sudah ada di atas
// Support: commandHub lama → mod.init()              ✅ ditambahkan ini
