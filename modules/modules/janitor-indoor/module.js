...
/* ============================================================
   CONFIG (internal, hanya fallback)
============================================================ */
...
/* ============================================================
   CSS (menggunakan variabel global, tapi tetap scoped)
============================================================ */
function injectCSS() {
...
/* ============================================================
   EXPORT DEFAULT — signature seragam dengan command center
============================================================ */
export default async function initModule(config, utils, supabase, currentUser, showToast, showModal, loader, translations, currentLang) {
    ...
    // Fallback untuk toast jika tidak disediakan
    ...
    /* ============================================================
       RENDER HTML (sama seperti sebelumnya, tapi gunakan esc)
    ============================================================ */
    function renderRoot(container) {
        ...
        <div id="janitor-in-root">
            ...
            <div class="ji-panel ji-header" style="margin-bottom:1.5rem">
                <div style="display:flex;align-items:center;gap:1rem;flex-wrap:wrap;">
                    ...
                    <div>
                        ...
                        <div style="font-size:0.75rem;color:var(--ji-text-muted);">Daily Cleaning Checklist & Report</div>
                    </div>
            ...
            <div id="ji-schedule-tab" class="tab-content" style="display:none;">
                <div class="ji-panel">
                    <h3 style="font-size:1.2rem;font-weight:700;margin-bottom:1.5rem;color:var(--ji-primary);">📅 Jadwal Piket Mingguan</h3>
                    <div class="ji-table-wrap">
                        <table class="ji-table">
                            <thead>
                                <tr>
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            // Catat ke audit_logs
            await writeAuditLog('Janitor Indoor', `Ceklis ${lokasi} - ${shift} oleh ${petugas}`);
