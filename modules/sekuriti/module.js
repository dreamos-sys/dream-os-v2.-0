...
// import { store } from '../../core/store.js'; // tidak dipakai
    ...
    form?.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            const { error: uploadError } = await supabase.storage
                .from('sekuriti-foto') // ganti bucket khusus sekuriti
...
export function cleanup() {
    // Hapus event listener jika perlu (opsional, karena elemen akan dihapus)
